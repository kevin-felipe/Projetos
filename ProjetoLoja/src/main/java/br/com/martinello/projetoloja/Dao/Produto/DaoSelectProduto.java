 ...
 */
public class DaoSelectProduto {
    
    
    
     public List<MetodoBuscaProduto> buscaTabelaProduto(String nomeProduto) throws SQLException {
        ...
        return alterarPoduto;        
         ...
         public List<MetodoBuscaProduto> carregarTabelaIniciar() throws SQLException {
        ConnectionFactory factory = new ConnectionFactory();
        Connection connection = factory.recuperaConexao();
