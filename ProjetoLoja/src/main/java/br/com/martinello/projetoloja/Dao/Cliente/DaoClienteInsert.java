 ...
 */
public class DaoClienteInsert {
    public DaoClienteSelect insertTelaCadastroCliente(MetodoCliente metodosCliente) throws SQLException {
        try {
            ...
            stm.setString(13, metodosCliente.getUf());
